...
and GatewayReceiveEventConverter () =
    ...
    override __.Read (reader, _, _) =
        ...
        | GatewayOpcode.HEARTBEAT, None -> GatewayReceiveEvent.HEARTBEAT <| Json.deserializeF json
    ...
    override __.Write (writer, value, options) =
        match value with
        | GatewayReceiveEvent.HEARTBEAT h -> Json.serializeF h |> writer.WriteRawValue
